...
import pytest
import os
from sitv.models.loader import ModelService
...
class TestCheckSavedModelsExist:
    ...
    def test_no_models_exist(self, temp_output_dir):
        ...
        assert ModelService.check_saved_models_exist(temp_output_dir) is False
    ...
    def test_both_models_exist(self, temp_output_dir):
        ...
        assert ModelService.check_saved_models_exist(temp_output_dir) is True
